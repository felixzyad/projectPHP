...
<div class="container my-5">
    <h2> <center>List of users from database</center>  </h2>
    <center> <a  class="btn btn-primary" href="create.php" role="button">  Add Clients</a></center>
     <br>
    <center> <a  class="btn btn-primary" href="btn.php" role="button">  Back</a></center>
